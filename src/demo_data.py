...
def get_demo_couple() -> HouseholdProfile:
    ...
    return HouseholdProfile(
        person_a=partner1,
        person_b=partner2,
        shared_monthly_expenses=MonthlyExpenses(misc=30_000),
        num_dependents=1,
        combined_emergency_fund=partner1.emergency_fund + partner2.emergency_fund,
    )
    ...
    return Portfolio(
        ...
        holdings=[
            FundHolding(
                ...
                expense_ratio=0.77,
                transactions=[
                    Transaction(date=date(2022, 1, 10), type=TransactionType.SIP, amount=5000, nav=45.0, units=111.11, scheme_name="HDFC Flexi Cap Fund - Direct Growth", folio="12345678"),
                    Transaction(date=date(2022, 7, 10), type=TransactionType.SIP, amount=5000, nav=48.0, units=104.17, scheme_name="HDFC Flexi Cap Fund - Direct Growth", folio="12345678"),
                    Transaction(date=date(2023, 1, 10), type=TransactionType.SIP, amount=5000, nav=52.0, units=96.15, scheme_name="HDFC Flexi Cap Fund - Direct Growth", folio="12345678"),
                    Transaction(date=date(2023, 7, 10), type=TransactionType.SIP, amount=5000, nav=55.0, units=90.91, scheme_name="HDFC Flexi Cap Fund - Direct Growth", folio="12345678"),
                    Transaction(date=date(2024, 1, 10), type=TransactionType.SIP, amount=5000, nav=60.0, units=83.33, scheme_name="HDFC Flexi Cap Fund - Direct Growth", folio="12345678"),
                ],
            ),
            FundHolding(
...
DEMO_PROFILES = {
    ...
    "couple": {
        "name": "Priya & Vikram Mehta (Couple)",
        "description": "Dual-income couple, joint tax optimization",
        "profile": get_demo_couple,
    },
}
